...
int main()
{
    ...
    return 0;
} // MODIFICAR EL EJERCICIO PARA EL CASO QUE SI EL RESULTADO DE "X" ES POSITIVO Y MAYOR A 2, EL RESULTADO DE "Y", DEBERA SER ELEVADO AL CUADRADO, 
// CASO CONTRARIO SE LE RESTARA 2
